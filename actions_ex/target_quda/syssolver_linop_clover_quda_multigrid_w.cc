...
namespace Chroma
{
  namespace LinOpSysSolverQUDAMULTIGRIDClover2Env
  {
    ...
    {
      return new LinOpSysSolverQUDAMULTIGRIDClover2(A, state,SysSolverQUDAMULTIGRIDCloverParams(xml_in, path));
    }
  ...
  LinOpSysSolverQUDAMULTIGRIDClover2::qudaInvert(const CloverTermT<T, U>& clover,
