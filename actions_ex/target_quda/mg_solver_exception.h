...
namespace Chroma  {
  ...
  class MGSolverException2 : public std::exception 
  {
  public: 
    MGSolverException2(const Real& Mass, const std::string& SubspaceId, int Iters, const Real& Rsd, const Real& RsdTarget) : 
