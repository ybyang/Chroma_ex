...
namespace Chroma
{
  namespace MdagMSysSolverQUDAMULTIGRIDClover2Env
  {
    ...
    {
      //! Name to be used
      const std::string name("QUDA_MULTIGRID_CLOVER_INVERTER_v2");
    ...
    {
      return new MdagMSysSolverQUDAMULTIGRIDClover2(A, state,SysSolverQUDAMULTIGRIDCloverParams(xml_in, path));
    }
  ...
  MdagMSysSolverQUDAMULTIGRIDClover2::qudaInvert(const CloverTermT<T, U>& clover,
    ...
    QDPIO::cout << "   QUDA_MULTIGRID_CLOVER_INVERTER_v2   "   <<std::endl;
  ...
  void  MdagMSysSolverQUDAMULTIGRIDClover2::dumpYSolver(const LatticeFermion& chi, const LatticeFermion& Y) const
  {
  ...
  unsigned long MdagMSysSolverQUDAMULTIGRIDClover2::seqno = 0;

  void  MdagMSysSolverQUDAMULTIGRIDClover2::dumpXSolver(const LatticeFermion& chi,
