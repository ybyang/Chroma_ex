...
#ifndef __syssolver_linop_quda_multigrid_clover_h_v2__
#define __syssolver_linop_quda_multigrid_clover_h_v2__
...
namespace Chroma
{
	...
	namespace LinOpSysSolverQUDAMULTIGRIDClover2Env
	{
	...
	class LinOpSysSolverQUDAMULTIGRIDClover2 : public LinOpSystemSolver<LatticeFermion>
	{
	public:
		 ...
		 */
		LinOpSysSolverQUDAMULTIGRIDClover2(Handle< LinearOperator<T> > A_,
...
//			quda_inv_param.verbosity_precondition = QUDA_SILENT;
                        ...
                        quda_inv_param.verbosity_precondition = QUDA_SUMMARIZE;
...
// merged from mdgam_clover_quda_multigrid, end  
		...
		~LinOpSysSolverQUDAMULTIGRIDClover2()
		{
